...
const data = [
  ...
  {
    title: 'Test End Article',
    date: 'Sep 2nd, 2019',
    firstParagraph: `Test test test test test test test test test test test test test test test test test test test test test test test test test
